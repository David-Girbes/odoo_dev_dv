...
class tareas_david(models.Model):
    _name = 'gestion_tareas_david.tareas_david'
    _description = 'gestion_tareas_david.tareas_david'
...
class sprints_david(models.Model):
    ...
    tareas = fields.One2many(
        'gestion_tareas_david.tareas_david', 
        'sprint', 
    ...
    class tecnologias_david(models.Model):
        ...
        rel_tareas = fields.Many2many(
            comodel_name='gestion_tareas_david.tareas_david',
            relation='relacion_tareas_tecnologias',
